...
namespace GiftOfTheGivers.Data.Migrations
{
    ...
    [Migration("20260924191049_P1PaymentsEmailAndStatuses")]
    partial class P1PaymentsEmailAndStatuses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GiftOfTheGivers.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftOfTheGivers.Models.Inquiry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftOfTheGivers.Models.ReliefProject", b =>
                {
                    ...
                    b.ToTable("ReliefProjects", t =>
                        {
                            t.HasCheckConstraint("CK_ReliefProject_Dates", "[EndDate] IS NULL OR [EndDate] >= [StartDate]");

                            t.HasCheckConstraint("CK_ReliefProject_FundsRequired_NonNegative", "[FundsRequired] >= 0");

                            t.HasCheckConstraint("CK_ReliefProject_Status", "[Status] IN ('Active','Completed','Suspended')");
                        });
                });
            ...
            modelBuilder.Entity("GiftOfTheGivers.Models.Volunteer", b =>
                {
                    ...
                    b.ToTable("Volunteers", t =>
                        {
                            t.HasCheckConstraint("CK_Volunteer_Status", "[Status] IN ('Pending','Approved','Rejected')");
                        });
                });
